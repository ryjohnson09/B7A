################################################
# Name: RespRatio_B7A_Humi_AbxRes.R
# Author: Ryan Johnson
# Date Created: 8 February, 2019
# Purpose: Generate RR from humichip B7A data
#  but only consider abx resistance probes
################################################
...
ggsave(plot = RR_plot, filename = "results/figures/RespRatio_Humi_AbxRes_gene_B7A.png", height = 10, width = 7)
